...
-- e.g. 1 would be the primary screen and 2 the secondary screen.
  ...
  -- if s.index == 1 then
    ...
    require("crylia_bar.left_bar")(s, { s.layoutlist, s.systray, s.taglist, s.cpu_usage, s.ram_info })
    require("crylia_bar.right_bar")(s, { s.bluetooth, s.network, s.audio, s.kblayout, s.date, s.clock, s.battery, s.powerbutton })
